...
#  SampleCount | Average | Sum | Minimum | Maximum
 ...
 # is being monitored with CloudWatch.
    ...
    print (f'Found: %s' % metric)
    # Now create Alarm for the metric
    print (f'Creating alarm')
